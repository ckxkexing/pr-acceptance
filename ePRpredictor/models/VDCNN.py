...
class VDCNN(nn.Module):
    def __init__(
        ...
        layers.append(
            nn.Conv1d(embedding_dim, base_num_features, kernel_size=3, padding=1)
        )
        ...
        layers.append(
            ConvBlock(
                input_dim=base_num_features,
                n_filters=base_num_features,
                kernel_size=3,
                padding=1,
                shortcut=shortcut,
            )
        ...
        fc_layers.extend(
            [nn.Linear(8 * 8 * base_num_features, n_fc_neurons), nn.ReLU()]
        )
